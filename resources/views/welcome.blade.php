...
<body class="relative min-h-screen bg-gradient-to-br from-blue-600 via-purple-600 to-indigo-600 dark:from-gray-900 dark:to-gray-800 text-gray-800 dark:text-gray-100 flex flex-col items-center justify-center p-6">

    <!-- Background Shape (Optional) -->
    <div class="absolute top-0 left-0 w-full h-full z-0 overflow-hidden">
        <div class="absolute -top-16 -left-16 w-96 h-96 bg-blue-100 dark:bg-blue-900 rounded-full mix-blend-multiply filter blur-3xl opacity-40 animate-pulse"></div>
        <div class="absolute -bottom-20 -right-20 w-96 h-96 bg-purple-100 dark:bg-purple-800 rounded-full mix-blend-multiply filter blur-3xl opacity-40 animate-pulse"></div>
    </div>

    <!-- Welcome Section -->
    <main class="z-10 text-center max-w-2xl">
        <!-- Main Heading -->
        <h1 class="text-5xl sm:text-6xl font-bold mb-6 text-white drop-shadow-lg">
            Welcome to Our Platform
        </h1>
        <!-- Motivational Quote -->
        <p class="text-xl mb-10 text-gray-100 italic font-semibold">
        ...
        <div class="flex justify-center gap-6">
            ...
            @if (Route::has('login'))
                <a href="{{ route('login') }}"
                    class="px-8 py-3 rounded-lg border border-blue-600 hover:bg-blue-700 text-white text-lg font-semibold shadow-lg hover:shadow-xl transition duration-300 transform hover:scale-110 hover:shadow-blue-500/50 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-opacity-50">
                    Login
                </a>
            @endif
            ...
            @if (Route::has('register'))
                <a href="{{ route('register') }}"
                    class="px-8 py-3 rounded-lg text-white border border-white hover:bg-white hover:text-purple-600 text-lg font-semibold shadow-lg hover:shadow-xl transition duration-300 transform hover:scale-110 hover:shadow-purple-500/50 focus:outline-none focus:ring-2 focus:ring-purple-500 focus:ring-opacity-50">
                    Register
                </a>
            @endif
        </div>
